...
import com.example.qiutt.demo.paypal.PayPalClient;
 ...
 */
public class CreateOrderAuthorize extends PayPalClient {
	...
	private OrderRequest buildRequestBody() {
		...
		PurchaseUnitRequest purchaseUnitRequest = new PurchaseUnitRequest().referenceId("PUHF")
				...
				.items(new ArrayList<Item>() {
					private static final long serialVersionUID = -1568233133496388161L;
	...
	public static void main(String args[]) {
		try {
			new CreateOrderAuthorize().createOrder(true);
